        ...
        <div className="flex-1 flex flex-col">
          ...
          <form onSubmit={handleEmailSubscribe} className="space-y-3 flex-1 flex flex-col">
            <InputField
              ...
              className="w-full rounded-sm border border-border-100 bg-background-50 px-4 py-2.5 text-sm text-foreground-50 placeholder:text-foreground-400 focus:outline-none focus:ring-2 focus:ring-primary-500/50 focus:border-primary-500 disabled:opacity-50 disabled:cursor-not-allowed transition-[border-color,box-shadow]"
            />
