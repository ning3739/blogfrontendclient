...
import { FileText, Scale, Share2 } from "lucide-react";
...
const CopyrightPage: React.FC = () => {
  ...
  const sections = [
    {
      icon: FileText,
      title: t("contentOwnership.title"),
      content: t("contentOwnership.content"),
    },
    {
      icon: Share2,
      title: t("sharingPolicy.title"),
      content: t("sharingPolicy.content"),
    },
    {
      icon: Scale,
      title: t("legalDisclaimer.title"),
      content: t("legalDisclaimer.content"),
    },
  ];
